...
# --- 🌷 Encabezado ---
st.markdown("<h1>✨ Pinterest Style - TF-IDF Q&A Demo 💕</h1>", unsafe_allow_html=True)
st.write("""
🩷 Esta aplicación analiza similitudes entre textos usando **TF-IDF**.  
Cada línea se trata como un documento, y puedes hacer preguntas en inglés para ver qué texto se relaciona más.
""")
